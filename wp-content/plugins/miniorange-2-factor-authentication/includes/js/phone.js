...
! function(a, b, c) {
    ...
    d.prototype = {
        init: function() {
            ...
            "" !== e.val() || this.options.americaMode || e.val("+1"), e.wrap(a("<div>", {
            ...
            this.appendListItems(d, j), a("<li>", {
                "class": "divider"
            }).appendTo(j), this.appendListItems(intlTelInput.countries, j);
            var k = j.children(".country");
            k.first().addClass("active"), e.keyup(function() {
                var c = b.getDialCode(e.val()) || "1",
                    d = intlTelInput.countryCodes[c],
                    f = !1;
                ...
                if (d.stopPropagation(), j.hasClass("hide")) {
                    ...
                    b.scrollTo(f, j), j.removeClass("hide"), a(c).bind("keydown.intlTelInput", function(c) {
                        if (38 == c.which || 40 == c.which) {
                            var d = j.children(".highlight").first(),
                        ...
                        } else if (9 == c.which || 27 == c.which) b.closeDropdown(j);
                        else if (c.which >= 97 && c.which <= 122 || c.which >= 65 && c.which <= 90) {
                            var i = String.fromCharCode(c.which),
                                l = k.filter(function() {
        ...
        getDialCode: function(a) {
            ...
            if ("+" == b.substring(0, 1))
                for (var c = b.replace(/\D/g, "").substring(0, 4), d = c.length; d > 0; d--)
                    if (c = c.substring(0, d), intlTelInput.countryCodes[c]) return c;
            return ""
        },
