...
class Miniorange_Rba_Attributes{
	...
	function mo2f_collect_attributes($useremail,$rba_attributes){
		...
		$url = get_site_option('mo2f_host_name') . '/moas/rest/rba/acs';
		$ch = curl_init($url);
	...
	function mo2f_evaluate_risk($useremail,$sessionUuid){
		...
		$url = get_site_option('mo2f_host_name') . '/moas/rest/rba/evaluate-risk';
		$ch = curl_init($url);
	...
	function mo2f_register_rba_profile($useremail,$sessionUuid){
		...
		$url = get_site_option('mo2f_host_name') . '/moas/rest/rba/register-profile';
		$ch = curl_init($url);
	...
	function mo2f_get_app_secret(){
		...
		$url = get_site_option('mo2f_host_name') . '/moas/rest/customer/getapp-secret';
		$ch = curl_init($url);
	...
	function mo2f_validate_google_auth($useremail,$otptoken,$secret){
		...
		$url = get_site_option('mo2f_host_name') . '/moas/api/auth/validate-google-auth-secret';
		$ch = curl_init($url);
