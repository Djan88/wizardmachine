<div class="mo2f_table_layout">
   ...
   <center>
      <div id="myCarousel1" class="mo2f_carousel slide" data-ride="carousel"  data-interval="15000">
         ...
         <div class="mo2f_carousel-inner" role="listbox">
            <div class="item active">
               <center>
                  <b>
                     <p>Select <b style="color:red">OTP Over SMS</b> from Setup Two-Factor Tab.</p>
                  </b>
               </center>
            ...
            <div class="item">
               <center>
                  <b>
                     <p>Enter your phone number and click on verify button.</p>
                  </b>
               </center>
            ...
            <div class="item">
               <b>
                  <p>A one time passcode is sent to your mobile number. Enter the one time passcode here and click on <b style="color:red">Validate OTP</b> button.</p>
               </b>
            ...
            <div class="item">
               <center>
                  <b>
                     <p>OTP Over SMS is set as your 2-factor method. PHONE VERIFICATION/OTP OVER SMS AND EMAIL have been setup as well.</p>
                  </b>
               </center>
      ...
      <h3>
      How to Setup OTP Over SMS And Email? 
      <div style="float:right;"><a href="admin.php?page=miniOrange_2_factor_settings&amp;mo2f_tab=mobile_configure">←Back</a></div>
   </h3>
   <hr>
   <center>
   <div id="myCarousel12" class="mo2f_carousel slide" data-ride="carousel"  data-interval="15000">
      <ol class="mo2f_carousel-indicators">
      ...
      <div class="mo2f_carousel-inner" role="listbox">
         <div class="item active">
            <center>
               <b>
                  <p>Select <b style="color:red">OTP Over SMS and Email</b> from Setup Two-Factor Tab.</p>
               </b>
            </center>
            <img class="first-slide" style="padding-left:3%;" src="https://auth.miniorange.com/moas/images/help/mo2f_sms_and_email1.png" alt="First slide">
         </div>
         <div class="item">
            <center>
               <b>
            ...
            <img class="first-slide" style="padding-left:13%;" src="https://auth.miniorange.com/moas/images/help/mo2f_sms_and_email2.png" alt="First slide">
         </div>
         <div class="item">
            <b>
               <p>A one time passcode is sent to your mobile number and email address. Enter the one time passcode here and click on <b style="color:red">Validate OTP</b> button.</p>
            </b>
            <img class="first-slide" style="padding-left:13%;" src="https://auth.miniorange.com/moas/images/help/mo2f_sms_and_email3.png" alt="First slide">
         </div>
         <div class="item">
            <center>
               <b>
                  <p>OTP Over SMS and Email is set as your 2-factor method. PHONE VERIFICATION/OTP OVER SMS have been setup as well.</p>
               </b>
            </center>
            <img class="first-slide" style="padding-left:3%;" src="https://auth.miniorange.com/moas/images/help/mo2f_sms_and_email4.png" alt="First slide">
         </div>
      </div>
   </div>
   </center>
   ...
   <center>
      <div id="myCarousel8" class="mo2f_carousel slide" data-ride="carousel"  data-interval="15000">
         ...
         <div class="mo2f_carousel-inner" role="listbox">
            <div class="item active">
               <p><b>Enter your username and click on <b style="color:red">Login with 2nd factor.</b></b></p>
