...
Easily add Two Factor Authentication to protect sites from unauthorized login attempts.Support SMS,QR Code,Push,Google Authenticator,Authy,Device Id.
...
You can select the authentication methods under Login Settings tab. The selected authentication methods will be shown to the user during inline registration.
...
= 4.1.2 = Google Authenticator for Windows Phone and bootstrap css fix for front-end site 

= 4.1.1 = Adding validation in choosing Security Questions (KBA)

= 4.1.0 = Premium Plugin
