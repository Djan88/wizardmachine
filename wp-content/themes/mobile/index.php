...
<?php } else { ?>
	<div class="col col-12 col-sm-12 col-md-8 col-lg-6 col-xl-6 protocols">
		<?php if(is_user_logged_in()){ ?>
	        ...
	        <p>
	        	Для новых пользователей доступен бесплатный 3-х дневный доступ к протоколу "Универсальный". Протокол отстутствует в мобильной версии программы. Для того чтоб вопольозоваться тестовым доступом перейдите полную версию программы.
	        </p>
	        <p>
