                    ...
                    <div id="accordion" class="select_program">
                        ...
                        <div>NB! Протокол на ручном управлении, предназначен для продвинутых пользователей! Производит синхронизацию телесных и внетелесных ресурсных зон c калибровкой по зоне сердца (V3). В целях безопасности предусмотрено автоматическое отключение протокола через 30 секунд простоя!
                            <div class="zone-choice_wrap">
                                <div class="zone-choice_item"><input class="v-zone" type="radio" name="radiobutton"value="1" id="V1"><label for="V1">V1</label></div>
                                <div class="zone-choice_item"><input class="v-zone" type="radio" name="radiobutton" value="2" id="V2"><label for="V2">V2</label></div>
                                <div class="zone-choice_item"><input class="v-zone" type="radio" name="radiobutton" checked="checked"  value="3" id="V3"><label for="V3">V3</label></div>
                                <div class="zone-choice_item"><input class="v-zone" type="radio" name="radiobutton" value="4" id="V4"><label for="V4">V4</label></div>
                                <div class="zone-choice_item"><input class="v-zone" type="radio" name="radiobutton" value="5" id="V5"><label for="V5">V5</label></div>
                            </div>
