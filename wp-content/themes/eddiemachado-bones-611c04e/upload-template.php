            ...
            <?php if(current_user_can('contributor') || current_user_can('administrator')) { ?>
                ...
                <div class="machine_screen clearfix">
                    ...
                    <div id="accordion" class="select_program">
                        ...
                        <h3><span class="protocol_acent">(V5)</span>ОДНИ И ТЕ ЖЕ "ГРАБЛИ»: РЕЦИДИВЫ ПРОБЛЕМНЫХ СИТУАЦИЙ В ЛИЧНОЙ ЖИЗНИ</h3>
                        <div>«Иррациональное (сменить название) Ощущение непреодолимой и целиком захватывающей  силы и энергии.Насильственное следование некой жизненной стратегии, витальные страхи.»<div class="btn btn_lg btn_success btn_choice" data-protocol ="v5">Выбрать</div></div>
                        <h3><span class="protocol_acent">(РЕСУРС)</span>«ИРРАЦИОНАЛЬНОЕ, ВИТАЛЬНАЯ СИЛА»</h3>
