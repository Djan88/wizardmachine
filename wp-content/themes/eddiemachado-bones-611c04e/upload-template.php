...
<div id="content">
    ...
    <div id="inner-content" class="wrap cf">
        ...
        <?php if(is_user_logged_in()){ ?>
            ...
            <?php } else { ?>
                <div class="subscriber_info">Вы видите это сообщение, потому, что зарегистрированы на сайте <a href="http://wizardmachine.ru/">"WizardMachine"</a> но на данный момент Вы не имеете действующего доступа к программе. Преобрести доступ к "WizardMachine" вы можете из <a href="/kabinet/">личного кабинета</a> пользователя (вкладка "Все доступы"). Напоминаем что действвующие пользователи могут продлить доступ к "WizardMachine" со скидкой 30%, для этого перейдите в <a href="/kabinet/">личный кабинет</a> пользователя, во вкладку "Текущий доступ" (дотупно при наличии действующиего доступа к программе. Если Вы не успели продлить доступ до окончания срока действия лицензии обратитесь в техподдержку — <a href="mailto:info@chikurov.com">info@chikurov.com</a>. Вам оперативно ответят.
                  <p>Если у Вас есть вопросы, их так-же можно задать службе технической поддержки пользователей написав на <a href="mailto:info@chikurov.com">info@chikurov.com</a></p>
                </div>
            <?php } ?>
        <?php } else { ?>
