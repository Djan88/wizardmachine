    ...
    phaseOne = setInterval(function(){
        ...
        jQuery('body').on('click', function(event) {
            ...
            jQuery('#itemlist-two').on('click', function(e) {
                ...
                v7x= v7x-20;
                jQuery('#itemlist-two').append('<li id="draggable3" class="itemlist_item item_list__mid draggable ui-draggable ui-draggable-handle" style="left: '+v7x+'px; top: '+v7y+'px; color: transparent; border-color: transparent; opacity: 0.8; transform: scale(1); border-width: 1px; padding-top: 4px; z-index: 1000; background: url(http://yuchikurov.ru/wp-content/themes/eddiemachado-bones-611c04e/library/images/resurs.png) 0px 0px / 100% no-repeat rgba(255, 255, 255, 0.1);">V3</li>');
            });
        });
            resorceGlobal -= 1;
            jQuery('#draggable3').css({
