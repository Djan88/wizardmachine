    ...
    //анимация против часовой стрелки
        ...
        firstTriangleAnimation = new Vivus('triangle_D_1', {type: 'delayed', duration: 150}, function(){
        //анимация второго треугольника
            setTimeout(function(){
                jQuery('#draggable2').addClass('transparent');
                secondTriangleAnimation = new Vivus('triangle_2', {type: 'delayed', duration: 150}, function(){
                ...
                phaseOne = setInterval(function(){
                    if (count_animation <= 9){                                                                         //9
                        ...
                        if (count_animation >= 0 && count_animation <= 1){
                            jQuery('#draggableS_1').css( 'background', '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/simvoly.001.jpg) center center/100% no-repeat');
                        } else if (count_animation > 1 && count_animation <= 2) {
                            jQuery('#draggableS_1').css( 'background', '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/simvoly.002.jpg) center center/100% no-repeat');
                        } else if (count_animation > 2 && count_animation <= 3) {
                            jQuery('#draggableS_1').css( 'background', '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/simvoly.004.jpg) center center/100% no-repeat');
                        } else if (count_animation > 3 && count_animation <= 4) {
                            jQuery('#draggableS_1').css( 'background', '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/simvoly.005.jpg) center center/100% no-repeat');
                        } else if (count_animation > 4 && count_animation <= 5) {
                            jQuery('#draggableS_1').css( 'background', '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/simvoly.006.jpg) center center/100% no-repeat');
                        } else if (count_animation > 5 && count_animation <= 6) {
                            jQuery('#draggableS_1').css( 'background', '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/simvoly.007.jpg) center center/100% no-repeat');
                        } else if (count_animation > 6 && count_animation <= 7) {
                            jQuery('#draggableS_1').css( 'background', '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/simvoly.008.jpg) center center/100% no-repeat');
                        } else {
                            jQuery('#draggableS_1').css( 'background', '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/simvoly.009.jpg) center center/100% no-repeat');
                        };
                        count_animation += 1;
                    } else {
                        clearInterval(phaseOne);
...
//фаза 2
            ...
            phaseOne = setInterval(function(){
                if (count_animation <= 150){                                                                         //150
                    cur_animation_val += 6;
                    jQuery('#draggableClean_2, #draggableClean_3, #draggableS4, #draggableS5, #draggableS6, #draggableD5, #draggable5').css({
                        transform: 'scale(1)',
                        borderWidth: '1px',
                        color: 'transparent',
                        borderColor: 'transparent',
                                        ...
                                        setTimeout(function(){
                                            ...
                                            //фаза 4
                                                                            ...
                                                                            phaseOne = setInterval(function(){
                                                                                if (count_animation <= 120){                                                                         //120
                                                                                    cur_animation_val += 6;
                                                                                    jQuery('#draggableS1, #draggableD_1, #draggable5').css({
                                                                                        transform: 'scale(1)',
                                                                                        borderWidth: '1px',
                                                                                        color: 'transparent',
                                                                                        borderColor: 'transparent',
...
face = function(){
    ...
    phaseOne = setInterval(function(){
        if (count_animation <= 120){                                                                         //120
            jQuery('#draggableClean_2, #draggableClean_3, #draggableClean_4, #draggableD5, #draggableD_6, #draggableS_1').css({
                color: 'transparent',
                borderColor: 'transparent',
                opacity: 0.8,
                transform: 'scale(1)',
        ...
        //фаза 1
            ...
            phaseOne = setInterval(function(){
                if (count_animation <= 120){                                                                         //120
                    cur_animation_val += 6;
                    jQuery('#draggableD_1, #draggableS1').css({
                        borderWidth: '1px',
                        borderColor: 'transparent',
                        opacity: 0.8,
                        paddingTop: '4px',
