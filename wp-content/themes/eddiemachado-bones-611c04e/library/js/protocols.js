                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            //анимация четвертого треугольника
                                                                                                                                                                                                                                                setTimeout(function(){
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    //Фаза 8
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                phaseOne = setInterval(function(){
                                                                                                                                                                                                                                                                    if (count_animation <= 120){                                                                         //120
                                                                                                                                                                                                                                                                        jQuery('#draggable2, #draggable3, #draggableS2').css({
                                                                                                                                                                                                                                                                            color: 'transparent',
                                                                                                                                                                                                                                                                            borderColor: 'transparent',
                                                                                                                                                                                                                                                                            opacity: 0.8,
                                                                                                                                                                                                                                                                            transform: 'scale(1)',
    ...
    //фаза 1
                        ...
                        phaseOne = setInterval(function(){
                            if (count_animation <= 344){                                                                         //90
                                ...
                                jQuery('#draggableS2, #draggableS3').css({
                                    background: '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/travma.jpg) 0 0/100% no-repeat'
                                });
                                jQuery('#draggableD12')
                                    .removeClass('hidden')
                                ...
                                clearInterval(phaseOne);
                                count_animation = 1;
                                jQuery('#draggableS2, #draggableS3, #draggableS4, #draggableS5, #draggableS6').css({
                                    background: 'rgba(255,255,255, 0.5)',
                                    color: 'red',
                                    borderColor: 'red',
                                    opacity: 1,
...
//фаза 1
    ...
    phaseOne = setInterval(function(){
        if (count_animation <= 480){                                                                         //120
            cur_animation_val += 1.5;
            jQuery('#draggableClean_2, #draggable2, #draggableD1, #draggableVD, #draggableClean').css({
                transform: 'scale(1)',
                borderWidth: '1px',
                color: 'transparent',
                borderColor: 'transparent',
            ...
            jQuery('#draggableVD, #draggableClean').css({
                transform: 'rotate(-'+cur_animation_val+'deg) scale(1)',
                background: '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/lovushka.jpg) 0 0/100% no-repeat'
            });
            jQuery('#draggable2').css({
