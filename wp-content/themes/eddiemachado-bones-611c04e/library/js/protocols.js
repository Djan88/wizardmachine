    ...
    //фаза 3
                        ...
                        phaseThree = setInterval(function(){
                            if (count_animation <= 120){                                                         //120
                                cur_animation_val += 6;
                                jQuery('#draggable4, #draggable5, #draggableD4, #draggableD5, #draggableClean_2, #draggableClean_4').css({
                                    borderWidth: '1px',
                                    paddingTop: '4px',
                                    zIndex: '1000',
                                    color: 'transparent',
                                ...
                                phaseFour = setInterval(function(){
                                    if (count_animation <= 150){                                                //150
                                        ...
                                        jQuery('#draggable0, #draggableVD').css({
                                            background: '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/vaterfall.jpg) 0 0/100% no-repeat',
                                            transform: 'rotate(-'+cur_animation_val+'deg) scale(1)'
                                        });
    ...
    //фаза 2
                                                                ...
                                                                phaseOne = setInterval(function(){
                                                                    if (count_animation <= 480){                                                                         //120
                                                                        ...
                                                                        jQuery('#draggableD2, #draggableClean, #draggableD4, #draggableD5').css({
                                                                        ...
                                                                        jQuery('#draggableClean_2, #draggable1, #draggable4, #draggable5, #draggableD1, #draggableD2, #draggableClean, #draggableD4, #draggableD5').css({
                                                                            color: 'transparent',
                                                                            borderColor: 'transparent',
                                                                            opacity: 0.8,
                                                                            transform: 'scale(1)',
    ...
    //фаза 1
        ...
        phaseOne = setInterval(function(){
            if (count_animation <= 120){                                                                         //120
                ...
                jQuery('#draggableClean, #draggableS1, #draggableS2_1, #draggableS4, #draggableS5').css({
                    transform: 'rotate(-'+cur_animation_val+'deg) scale(1)',
                    background: '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/lovushka.jpg) 0 0/100% no-repeat'
                });
                jQuery('#draggableD1').css({
...
//фаза 1
    ...
    phaseOne = setInterval(function(){
        if (count_animation <= 480){                                                                         //120
            ...
            jQuery('#draggableClean_3, #draggableVD').css({
                transform: 'rotate(-'+cur_animation_val+'deg) scale(1)',
                background: '#fff url(/wp-content/themes/eddiemachado-bones-611c04e/library/images/lovushka.jpg) 0 0/100% no-repeat'
            });
