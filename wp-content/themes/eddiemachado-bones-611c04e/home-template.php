            ...
            <div class="home-page-content">
                ...
                <?php if(is_user_logged_in()){ ?>
                    ...
                    <?php } elseif(current_user_can('contributor') || current_user_can('administrator')) { ?>
                        ...
                        <?php }?>
                        <div><a href="http://help.yandex.ru/common/support/screenshot.xml" target="_blank" class="button button-primary button-large button__main">Как сделать "скриншот" экрана</a></div>
                ...
                <?php } else { ?>
                    <div class="home-content" style="text-align: center;">
                        ...
                        <a href="/pay/" target="_blank" class="button button-primary button-large button__main">Оплата доступа</a>
