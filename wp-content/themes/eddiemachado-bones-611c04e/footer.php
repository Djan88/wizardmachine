            <?php if(!is_front_page()){ ?>
                <footer class="footer" role="contentinfo">
                    ...
                    <?php } ?>
                        ...
                        <p class="source-org copyright">&copy; <?php echo date('Y'); ?> <a href="/" class="homelink"><?php bloginfo( 'name' ); ?></a>. Версия 5.1 <?php if(is_user_logged_in()){ ?>| <a href="/kabinet">Личный кабинет</a> | 
