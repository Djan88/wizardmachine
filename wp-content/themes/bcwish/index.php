              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="footer-info">
                    ...
                    <p><b>"WizardMachine"</b> корректирует нарушения в тонких планах через фото. <br>Позитивные эффекты проявляются на уровне переживаний физического тела и событийных рядов. <br>Процессинг полностью автоматизирован и ведётся по специальным протокол</b> 2015 г.</p>
                  </div>
                </div>
              </div>
            </div>
