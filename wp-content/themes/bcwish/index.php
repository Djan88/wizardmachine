              ...
              <div class="col-sm-4">
                <div class="card">
                  ...
                  <div class="card-block">
                    ...
                    <ul class="list-group">
                      <li class="list-group-item"><b>Если Вы тут впервые и хотите попробовать "WizardMachine"</b>, то программу можно оплачивать помесячно. Техническая поддержка так же включена в стоимость доступа</li>
                    </ul>
                  </div>
                </div>
              </div>
