...
<body>
  <div class="all_content">
    ...
    <header id="header">
      ...
      <button type="button" class="wizard_disbledMove hidden header_btn" data-toggle="popover" data-placement="bottom" title="Программа еще в ходу!" data-content="Для смены проткола нажмите на кнопку левее. После остановки программы нажмите 'Продолжить', и на эту кнопку.">
        <i class="fa fa-arrow-left"></i>
      </button>
      ...
      <button type="button" class="wizard_stop hidden header_btn" data-toggle="popover" data-placement="bottom" title="Протокол остановлен!" data-content="Выполнение протокола будет приостановлено по окончании текущей фазы. Все данные будут сохранены. Нажав на кноку со стрелкой (правее от этой) можно будет сменить протокол">
            ...
            <div class="col-md-12 intro-info order-md-first order-last">
              <?php if(is_user_logged_in()){ ?>
                ...
                <?php } else if (current_user_can('contributor') || current_user_can('administrator') || (current_user_can('subscriber') && $new_registred == 1)) { ?>
                  ...
                  <div>
                    <a href="#services" class="btn-get-started scrollto wm_init">Фото человека</a>
                    <?php if (current_user_can('contributor') || current_user_can('administrator')){ ?>
                     или 
                      <a href="#services" class="btn-get-started scrollto wm_init_estate">План помещения</a>
                    <?php } ?> 
                    ...
                    <div class="for_desktop">
                      ...
                      <?php if (current_user_can('contributor') || current_user_can('administrator')){ ?>
                       <span class="arrow_title main_arrow_title">Начните работу с загрузки фото человека или плана помещения.</span>
                      <?php } else { ?>
                        <span class="arrow_title main_arrow_title">Начните работу с загрузки фото человека.</span>
                      <?php } ?> 
                    </div>
                ...
                <div class="machine_screen clearfix">
                  <div class="bbody">
                    ...
                    <div>
                      ...
                      <img src="<?php bloginfo('template_url'); ?>/img/template_.png" alt="template" class="template_load template_load_human">
                      <img src="<?php bloginfo('template_url'); ?>/img/plan.png" alt="template" class="template_load template_load_estate hidden">
                    </div>
                    <div class="error"></div>
                    <div class="step2">
                  ...
                  <div class="col-md-12 wizard_estate hidden">
                    <div class="row">
                      <div class="col-sm-2 estate_items">
                        <div class="estate_center wow bounceInUp" data-wow-duration="1.4s" data-wow-delay="0.4s">
                          <div class="estate_heading" style="color: #636065;">Центр</div>
                          <div class="zone_estate zone_estate_center zone_default"><i class="fa fa-times" style="transform: rotate(45deg); margin-left: 2px;"></i></div>
                        </div>
                        <div class="estate_els wow bounceInUp" data-wow-duration="1.4s" data-wow-delay="0.6s">
                        ...
                        <div class="estate_doors wow bounceInUp" data-wow-duration="1.4s" data-wow-delay="1.0s">
                        ...
                        <div class="estate_wcs wow bounceInUp" data-wow-duration="1.4s" data-wow-delay="1.2s">
                          <div class="estate_heading" style="color: #19b55f;">С/У</div>
                        ...
                        <button class="btn btn-warning estate_pause hidden"  data-toggle="popover" data-placement="right" title="Протокол остановлен!" data-content="Выполнение протокола будет приостановлено по окончании текущей фазы. Все данные будут сохранены">Пауза</button>
              ...
              <div class="col-sm-4">
                <div class="card">
                  ...
                  <div class="card-block">
                    ...
                    <ul class="list-group">
                      <li class="list-group-item">Если Вы тут впервые и хотите попробовать <b>"WizardMachine"</b>, то программу можно оплачивать помесячно. Техническая поддержка так же включена в стоимость доступа</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="footer-info">
                    ...
                    <p><b>"WizardMachine"</b> корректирует нарушения в тонких планах через фото. <br>Позитивные эффекты проявляются на уровне переживаний физического тела и событийных рядов. <br>Процессинг полностью автоматизирован и ведётся по специальным протоколам.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-text">
            <div class="row" style="text-align: center;padding: 20px;font-size: 22px;">
              <div class="col-sm-12">
                <div class="row">
                  <div class="col-sm-5 col-xs-5 arrow_in_popup">
                  ...
                  <div class="col-sm-2 col-xs-2 screen_value"><span class="w_width"></span> px.</div>
                  <div class="col-sm-5 col-xs-5 arrow_in_popup">
                    <svg class="steps_icon" id="Слой_2" data-name="Слой 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400"><title>arrow_horizontal</title><path d="M5.91,188.77c14.72.16,29.5-.27,44.25-.52,7.39-.11,14.76-.17,22.14-.34l22.15-.23q44.28-.36,88.58.34c29.54.47,59.07,1.24,88.6,2.55s59.08,3,88.52,6.52l-.07,1.43c-14.79.46-29.55.68-44.32,1s-29.53.54-44.3.68q-44.29.39-88.6-.12c-29.53-.36-59.07-1.06-88.6-2.43-7.38-.31-14.77-.74-22.15-1.14s-14.77-1-22.15-1.47c-14.75-1.27-29.53-2.25-44.22-4.89Z"/><path d="M290.91,124.11a155.6,155.6,0,0,0,9,13.31c1.57,2.13,3.26,4.17,5,6.15s3.5,3.92,5.34,5.78a138.47,138.47,0,0,0,24.61,19.52c8.9,5.66,18.4,10.51,28,15.44,4.81,2.47,9.63,5,14.37,7.79s9.42,5.88,13.24,10h0l1.32.77-1.71.49c-10.4,3-20.66,5.84-30.82,8.93s-20.2,6.34-30,10.1a193.5,193.5,0,0,0-28.39,13.34,92.53,92.53,0,0,0-24.35,19.69l-1.2-.78A55.12,55.12,0,0,1,284.6,241a72.74,72.74,0,0,1,5.93-5.85q3.11-2.78,6.47-5.24a131.1,131.1,0,0,1,29-15.73,175.58,175.58,0,0,1,31.41-9.27q8-1.59,16.16-2.39a120.4,120.4,0,0,1,16.34-.57l-.39,1.26h0A85.67,85.67,0,0,0,375.26,196c-4.93-2.08-10-4-15-6a192.6,192.6,0,0,1-29.52-14.58,104,104,0,0,1-25.36-21.65,82,82,0,0,1-15.77-29.07Z"/></svg>
                  </div>
                </div>
              ...
              <div class="col-sm-12">
                Ширина экрана устройства не должна быть меньше 600px. Для работы на небольших планшетах и смартфонах предусмотрена "Мобильная версия". Для переключения на Мобильную версию программы выберите ее из списка ниже.
              </div>
